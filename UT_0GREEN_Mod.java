...
public class UT_0GREEN_Mod {
    ...
    public UT_0GREEN_Mod( int Yr, int Mo, int Da, int Hr, int Mt, int AMPM)
    {
    ...
    public void Julian ()
    {
       ...
       // JD2 = (int) ( 30.6001 * (  EM + 1. ));
        ...
        TJD = ( CJD-2451545.0  ) / 36525.;
        TJD_UT0 = ( JD_UT0-2451545.0 ) / 36525.;
        
        TJD_Plus =  ( CJD_Plus-2451545.0  ) / 36525.;
       
        CJD_0Hour = (int) JD1 + (int) JD2 + TDAY_0Hour + 1720994.5 + FIB;
        TJD_0Hour = ( CJD_0Hour-2451545.0  ) / 36525.;
