...
public class JULCEN_Mod {
	...
	public JULCEN_Mod ( double CJD, double TJD_UT0, double longitude, double latitude, double FR_univ, String E_W )
    {    	
    	TJD0 = TJD_UT0;
    	ELNGT = longitude;
    	ELTD = latitude;
	...
	public void ascend()
	{
		...
		//JD = 2457862.78263889;
		// T = TJD0 ;
		T = T = (JD - 2451545.0 ) / 36525;
		 // T = 0.8796030116358659;                     // Junk this
		//SIDE0 = 0.276919398 + T * ( 100.0021359 + T * 0.000001075 ) ;
		
		SIDE0D = 280.46061837 + 360.98564736629*(JD-2451545.0) + 0.000387933*T*T - T*T*T/38710000.0;
		SIDE0 = SIDE0D /15.;
